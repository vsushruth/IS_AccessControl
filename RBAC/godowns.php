...
<div class = "container-fluid row padding" >
    ...
    <div class="col-lg-8 col-md-6 col-sm-6" >
		...
		<?php
			...
			$perm_sql = "SELECT Write_Access FROM Access_Matrix WHERE Roles=$Role AND Objects_ID='godowns' ";
		...
		else
		{
			...
			if(mysqli_query($con, $q))
			{
				...
				while($local_role > 0){
					...
					if($local_role >= $Role){
						$access_add = "INSERT INTO `Access_Matrix`(`Roles`, `Objects_ID`, `Read_Access`, `Write_Access`) 
							VALUES ($local_role, $gid_added_str, true, true)";
					}
					else{
						$access_add = "INSERT INTO `Access_Matrix`(`Roles`, `Objects_ID`, `Read_Access`, `Write_Access`) 
							VALUES ($local_role, $gid_added_str, false, false)";
					}
